...
def run_rl():
    ...
    data = read_json("C:/Users/HANYUN/Desktop/新建文件夹/Job_Shop_Scheduling_Problem_with_Reinforcement_Learning-base/demo-DQN/data/bak/machining_preparation_input.json")
    dqn = DQN(config)
    result = []
    reward_his = []
    ENV = JSP(data)
    ...
    for epoch in range(5000):
        ...
        # pd.DataFrame(result, columns=["epoch", "epsilon", "time", "reward"]).to_csv("离散仿真.csv", index=False)
